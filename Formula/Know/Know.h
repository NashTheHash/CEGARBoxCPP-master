...
struct Know : public Formula, public enable_shared_from_this<Know> {
    ...
    static shared_ptr<Formula> create(int modality, int power, const shared_ptr<Formula> &subformula);
